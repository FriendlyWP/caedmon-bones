  ...
  if (!is_admin()) {
    ...
    if ( is_singular() AND comments_open() AND (get_option('thread_comments') == 1)) {
		...
		if ( is_page_template('tmpl-home.php') || is_page('testimonials') ) {
			// Flexslider
			wp_register_script( 'flexslider', get_stylesheet_directory_uri() . '/library/js/flexslider/jquery.flexslider-min.js', array( 'jquery' ), '', false );
...
function bones_theme_support() {
	...
	$args = array(
		...
		'flex-height'    => true,
		'height'        => 200,
		'default-image' => get_template_directory_uri() . '/library/images/caedmon-logo.png',
	);
	...
	register_nav_menus(
		array(
			...
			'social-nav' => __( 'The Social Menu', 'bonestheme' ),   // social nav in header
