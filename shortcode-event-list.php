...
<?php if( $eo_event_loop->have_posts() ): ?>
	...
	<ul <?php echo $id; ?> class="<?php echo esc_attr($classes);?>" > 
		...
		<?php while( $eo_event_loop->have_posts() ): $eo_event_loop->the_post(); ?>
			...
			<li class="<?php echo esc_attr(implode(' ',$eo_event_classes)); ?>" ><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><span class="event-time"><?php echo eo_get_the_start($format); ?></span>
				<span class="event-title"><?php the_title(); ?><span class="learnmore">Learn more</span></span></a>
			</li>
